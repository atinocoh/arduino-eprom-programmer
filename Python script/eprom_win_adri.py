...
while True:
    ...
    print("                                  ")
    print("          7-Read ZX Spectrum+ 128 eprom          ")
    print("                                  ")
    print("          8-quit                \n")
    ...
    if(option==1):
        ...
        while (numBytes<romsize):
            while ser.inWaiting()==0:
                print("Reading from eprom. Current porcentage:{:.2%}".format(numBytes/romsize),end='\n')
                time.sleep(0.1)
    ...
    if(option==4):
        ...
        if blank==1:
            ...
            print("\nThe chip seems to contain data in byte: ",(numBytes-1),"\n")
        print("Done\n")
